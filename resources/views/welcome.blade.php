                               ...
                               <form class="formulario">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <select name="ciudades" id="ciudades" v-model="form.ciudad" class="form-control py4">
                                           <option value="X">Seleccione una ciudad</option>
                                           <option name="ciudades" v-for="(value, key, index) in ciudades">
                                               @{{ value }}
                                           </option>
                                       </select>

                                       {{--<input class="form-control py-4" id="ciudad" type="text" v-model="form.ciudad" placeholder="Medellin" />--}}
                                   </div>
                                   <div class="form-group">
                                       <label class="small mb-1 font-weight-bold" for="nombre">Nombre*</label>
                                       <input class="form-control py-4" id="nombre" type="text" v-model="form.nombre" placeholder="Alexander Fonseca" />
                                   </div>
                                   <div class="form-group">
                                       <label class="small mb-1 font-weight-bold" for="correo">Email*</label>
                                       <input class="form-control py-4" id="correo" type="email" v-model="form.correo" placeholder="example@example.com" />
                                   </div>
